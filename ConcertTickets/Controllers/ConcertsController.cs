...
namespace ConcertTickets.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ConcertName,ConcertDate,ConcertPrice,ConcertPlace,ImageURL")] Concert concert)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,ConcertName,ConcertDate,ConcertPrice,ConcertPlace,ImageURL")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
